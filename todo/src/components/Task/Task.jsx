...
function Task(props) {
  return (
    <div className="task">
      ...
      onClick={() => {props.updateId(props.task.id); props.toggleWatching(true); props.toggleEditing(false); props.toggleAdding(false); props.updateTask(props.task.id); props.setEditingTaskId(-1)}}>Смот</button>
